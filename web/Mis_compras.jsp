...
<%
    ...
    dat=mod.ConsultarMisCompras(con);
%>
                            ...
                            <form method="POST" action="verCompra" name="Detalles ventas">
                               <%
                                ...
                                <tr>
                                            ...
                                            <td><button type="submit" class="btn btn-light" name="btneli" value="">Eliminar Pedido <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" class="bi bi-x" viewBox="0 0 16 16">
